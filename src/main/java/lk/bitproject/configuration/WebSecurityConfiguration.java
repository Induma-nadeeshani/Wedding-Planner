...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.
                ...
                .antMatchers("/index","/photographer","/serviceprovider/listbyphotographer","../providerpackage/listbyprovider?providerid=","../serviceprovider/listbyvehi").permitAll()
...
//all
                ...
                // all roles
                .antMatchers("/mainwindow","/user/**","/employee/**").hasAnyAuthority("ADMIN","MANAGER","OWNER","RECEPTIONIST","SUPERVISOR","ASSISTANT MANAGER")
                .antMatchers("/privilage/**").hasAnyAuthority("ADMIN","MANAGER","OWNER","RECEPTIONIST","SUPERVISOR","ASSISTANT MANAGER").anyRequest().authenticated()
