...
function loadForm() {
    ...
    fillCombo(cmbGender, "Gender", genders, "name", "");
    fillCombo(cmbDesignation, "Designation", designations, "name", "");
    fillCombo(cmbCivilstatus, "Civil Status", civilstatuses, "name", "");
    ...
    employee.regdate = dteRegDate.value;
    ...
    disableButtons(false, true, true);
    cmbEmployeestatus.setAttribute("disabled","disabled");
...
function getErrors() {
    ...
    if (employee.designationId == null){
        ...
        cmbEmployeestatus.style.border = invalid;
    }else addvalue = 1;
...
function btnClearMC() {
    ...
    if (oldemployee == null && addvalue == "") {
        ...
        swal({
            title: "Form has some values/updates values... " +
...
function filldata(emp) {
    ...
    txtNumber.disabled = "disabled";
    dteRegDate.value = employee.doassignment;
